...
<head>
 ...
 <!-- Image Page -->
 <link rel="shortcut icon" href="assets/dist/img/puerta.png" type="image/x-icon">
 ...
 <div class="login-box">
  <div class="card card-outline card-primary">
   <div class="card-header text-center">
    <h2 class="h2"><b>FERRETERÍA EL COMANDANTE</b></h2>
   </div>
   <div class="card-body">
    <div style="text-align: center;">
     <img src="vistas/assets/dist/img/candado.png" width="210px" alt="Imagen">
    </div>
    <br> <br>
    <form method="post" class="needs-validation-login" novalidate>
     <!-- USUARIO DEL SISTEMA -->
     <div class="input-group mb-3">
      <input type="text" class="form-control" placeholder="Usuario del sistema" id="loginUsuario" name="loginUsuario"
       required>
