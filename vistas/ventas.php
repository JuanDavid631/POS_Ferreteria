   ...
   <div class="col-md-9">
    <div class="row">
     ...
     <div class="col-md-6 mb-3">
      <h3>Total Venta: $ <span id="totalVenta">0</span></h3>
     </div>
   ...
   <div class="col-md-3">
    <div class="card shadow">
     <h5 class="card-header py-1 bg-primary text-white text-center">
      Total Venta: $ <span id="totalVentaRegistrar">0</span>
     </h5>
     <div class="card-body p-2">
      ...
      <div class="form-group">
       ...
       <input type="number" min="0" name="iptEfectivo" id="iptEfectivoRecibido" class="form-control form-control-sm"
      ...
      <div class="row mt-2">
       <div class="col-12">
        <h6 class="text-start fw-bold">Monto Efectivo: $ <span id="EfectivoEntregado">0</span></h6>
       </div>
       <div class="col-12">
        <h6 class="text-start text-danger fw-bold">Vuelto: $ <span id="Vuelto">0</span>
        </h6>
       </div>
      </div>
      ...
      <div class="row">
       ...
       <div class="col-md-5 text-right">
        $ <span class="" id="boleta_subtotal">0</span>
       </div>
       <div class="col-md-7">
        <span>IVA (19%)</span>
       </div>
       <div class="col-md-5 text-right">
        $ <span class="" id="boleta_igv">0</span>
       </div>
       <div class="col-md-7">
        <span>TOTAL</span>
       </div>
       <div class="col-md-5 text-right">
        $ <span class="" id="boleta_total">0</span>
       </div>
      </div>
     </div>
    </div>
 ...
 $.ajax({
  ...
  success: function(respuesta) {
   if (respuesta) {
    ...
    if (respuesta['aplica_peso'] == 1) {
     table.row.add({
      ...
      'acciones': "<center>" +
       ...
       "<li><a class='dropdown-item' codigo = '" + respuesta['codigo_producto'] + "' precio=' " + respuesta[
        'precio_venta_producto'] + "' style='cursor:pointer; font-size:14px;'>Normal (" + respuesta[
        'precio_venta_producto'] + ")</a></li>" +
       "<li><a class='dropdown-item' codigo = '" + respuesta['codigo_producto'] + "' precio=' " + respuesta[
        'precio_mayor_producto'] + "' style='cursor:pointer; font-size:14px;'>Por Mayor ($ " + parseFloat(
        respuesta['precio_mayor_producto']).toFixed(2) + ")</a></li>" +
       "<li><a class='dropdown-item' codigo = '" + respuesta['codigo_producto'] + "' precio=' " + respuesta[
        'precio_oferta_producto'] + "' style='cursor:pointer; font-size:14px;'>Oferta ($ " + parseFloat(
    ...
    Toast.fire({
     icon: 'error',
     title: ' El producto no existe o no tiene stock disponible'
    });
    $("#iptCodigoVenta").val("");
    $("#iptCodigoVenta").focus();
   }
